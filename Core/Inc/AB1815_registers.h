...
#define AB1815_REG_ID2 0x2A //!< Part revision (read-only)
#define AB1815_REG_ID3 0x2B //!< Lot number, lower (read-only)
#define AB1815_REG_ID4 0x2C //!< Manufacturing unique ID upper (read-only)
