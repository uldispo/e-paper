...
void set_week_alarm_weekday(uint8_t weekday, uint8_t hour, uint8_t minutes, uint8_t seconds);
// Hundredths, seconds, minutes, hours and weekday match (once per week)

void set_datetime_alarm_hour(uint8_t hour, uint8_t minutes, uint8_t seconds); // Hundredths, seconds, minutes and hours match (once per day)

void set_datetime_alarm_minutes(uint8_t minutes, uint8_t seconds); // Hundredths, seconds and minutes match (once per hour)

void set_datetime_alarm_seconds(uint8_t seconds); // Hundredths, seconds match (once per minute)

void set_once_second_alarm_hundredths(uint8_t hundredths); // Hundredths match (once per second)
